...
drafts_dir      = "_drafts"   # directory for draft blog posts
editor          = ""          # set editor (i.e. editor = "vi", etc) if you wish newly-created posts to automatically open for editing
